package com.example.demoalipay.utils;
...
import com.example.demoalipay.dto.BizContentForUniTransfer;
import com.example.demoalipay.dto.Participant;
import com.example.demoalipay.dto.TransferParams;
     ...
     */
     public AlipayFundTransUniTransferResponse doTransferNew(TransferParams transferParams) throws Exception {
        ...
        bizContent.setOut_biz_no(transferParams.getOutBizNo());
         int amount = Math.abs(Integer.parseInt(transferParams.getAmount())) / 100;
         bizContent.setTrans_amount(BigDecimal.valueOf(amount));
